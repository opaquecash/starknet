...
| `contracts/reputation_verifier` | `OpaqueReputationVerifierV2` port: root registry (1h TTL, delete-on-evict), u256 nullifier set, schema-liveness seam (OPQ-006) | Skeleton |
